...
## [Samuel Fang]'s remarks

### citations / worked with / received help from (other than Piazza threads, class-wide
### discussions, communication with Holmes via the class web site or GitHub repos)
- https://www.youtube.com/watch?v=0DeznFqrgAI
- Group chat (Eric Lau, Jason Wu, Adam Cohen)
